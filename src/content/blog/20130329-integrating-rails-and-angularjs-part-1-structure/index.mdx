...
description: "The first in a series exploring how to architect applications with Rails backend and AngularJS frontend, focusing on overall project structure."
authors: ["gio"]
slug: integrating-rails-and-angularjs-part-1-structure
