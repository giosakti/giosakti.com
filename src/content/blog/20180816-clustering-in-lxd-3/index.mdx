...
description: "Exploring LXD 3.0's clustering capabilities, including migration from 2.x, setting up multi-node clusters, and understanding current limitations."
authors: ["gio"]
slug: clustering-in-lxd-3
